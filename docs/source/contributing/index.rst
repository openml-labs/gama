...
To ensure a pleasant environment for everyone we ask that all our contributors adhere to the `code of conduct <https://github.com/PGijsbers/gama/blob/master/code_of_conduct.md>`_.

The best way to get started is by looking at the `Github Issues <https://github.com/PGijsbers/GAMA/issues>`_.
