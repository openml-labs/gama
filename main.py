...
from configuration import configuration_with_preprocessing, tpot_config
...
toolbox.register("expr", gen_grow_safe, pset=pset, min_=1, max_=3)
...
print([str(ind) for ind in pop])
from deap.algorithms import eaSimple
pop, log = eaSimple(pop, toolbox, cxpb=0.2, mutpb=0.8, ngen=5, verbose=True, stats=mstats)
