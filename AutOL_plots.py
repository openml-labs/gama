...
for d in [4,5,6]:
    for version in ["basic", "ensemble", "modelstore"]:
        with open("/home/bcelik/Results_AutOL/"+version+"/results_"+version+"_"+str(d)+".txt",'r') as f:
            lines = f.read().split("\n")
        output_file_perf = open("/home/bcelik/Results_AutOL/"+version+"/Performance_Output_"+ str(d)+".txt", "w")
        output_file_retrainings = open("/home/bcelik/Results_AutOL/"+version+"/Retrainings_Output_"+ str(d)+".txt", "w")
        output_file_update = open("/home/bcelik/Results_AutOL/"+version+"/Update_Output_"+ str(d)+".txt", "w")
...
=======
for d in [40,41]:
    with open("/Users/prabhant/OpenML/gama/Results_AutOL/Grace/results_ensemble_"+str(d)+".txt",'r') as f:
        lines = f.read().split("\n")
    output_file_perf = open("/Users/prabhant/OpenML/gama/Results_AutOL/Grace/Performance_Output_"+ str(d)+".txt", "w")
    output_file_retrainings = open("/Users/prabhant/OpenML/gama/Results_AutOL/Grace/Retrainings_Output_"+ str(d)+".txt", "w")
    output_file_update = open("/Users/prabhant/OpenML/gama/Results_AutOL/Grace/Update_Output_"+ str(d)+".txt", "w")
...
for d in [4, 5, 6]:  # data streams
    ...
    for version in ["basic", "ensemble", "modelstore"]:
        #Get performance
        read_perf = pd.read_table("/home/bcelik/Results_AutOL/"+version+"/Performance_Output_" + str(d) + ".txt", header=None, sep=' ')
        ...
        if os.path.getsize("/home/bcelik/Results_AutOL/"+version+"/Retrainings_Output_" + str(d) + ".txt") > 0:
            read_retraining = pd.read_table("/home/bcelik/Results_AutOL/"+version+"/Retrainings_Output_" + str(d) + ".txt", header=None, sep=' ')
        ...
        if version != "basic" and os.path.getsize("/home/bcelik/Results_AutOL/"+version+"/Retrainings_Output_" + str(d) + ".txt") > 0:
            read_update = pd.read_table("/home/bcelik/Results_AutOL/"+version+"/Update_Output_" + str(d) + ".txt", header=None, sep=' ')
...
for d in [40, 41]:  # data streams
    #Get performance
    read_perf = pd.read_table("/Users/prabhant/OpenML/gama/Results_AutOL/Grace/Performance_Output_" + str(d) + ".txt", header=None, sep=' ')
    ...
    if os.path.getsize("/Users/prabhant/OpenML/gama/Results_AutOL/Grace/Retrainings_Output_" + str(d) + ".txt") > 0:
        read_retraining = pd.read_table("/Users/prabhant/OpenML/gama/Results_AutOL/Grace/Retrainings_Output_" + str(d) + ".txt", header=None, sep=' ')
    ...
    if os.path.getsize("/Users/prabhant/OpenML/gama/Results_AutOL/Grace/Retrainings_Output_" + str(d) + ".txt") > 0:
        read_update = pd.read_table("/Users/prabhant/OpenML/gama/Results_AutOL/Grace/Update_Output_" + str(d) + ".txt", header=None, sep=' ')
